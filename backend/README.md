...
## Project Structure
    ...
    ├── testapiautosettings_75304  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_75304`
...
2. Clone this repo and `cd testapiautosettings_75304`
